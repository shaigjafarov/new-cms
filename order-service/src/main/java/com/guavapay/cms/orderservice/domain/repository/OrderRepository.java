...
public interface OrderRepository extends JpaRepository<Order,Long> {
    ...
    @Query("SELECT new com.guavapay.cms.orderservice.domain.model.CardDTO(o.cartType,o.cardPeriod,o.cardHolderName,o.urgent,o.codeWord) from Order o where o.id=:id and o.userId=:userId and o.status<> :status")
